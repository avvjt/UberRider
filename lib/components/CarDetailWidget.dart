      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(language.minimumFare, style: primaryTextStyle(color: Colors.white)),
              Text(appStore.currencyPosition == LEFT ? '${appStore.currencyCode} ${widget.service.minimumFare}' : '${widget.service.minimumFare} ${appStore.currencyCode}',
                  style: primaryTextStyle(color: Colors.white)),
            ],
          ),
          SizedBox(height: 16),
