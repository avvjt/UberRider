...
Widget totalCount({String? title, String? subTitle, String? description,bool? isTotal=false}) {
  return Row(
    ...
    children: [
      ...
      Text(appStore.currencyPosition == LEFT ? '${appStore.currencyCode} ${double.parse(subTitle!).toStringAsFixed(digitAfterDecimal)}' : '$subTitle ${appStore.currencyCode}', style: isTotal==true?boldTextStyle():primaryTextStyle()),
    ],
  );
}
